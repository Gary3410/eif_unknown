...
def main(args):
    ...
    # 初始化保存路径
    base_save_path = "./log_file/llava_s1_s2_vln_parsed_response_procthor_detic_v13_easy_random_choice_0513"
        ...
        while not success:
            ...
            if sem_map.check_is_found_object_in_map(target):
                ...
                if len(frontiers_label_dict_list) >= 1:
                    frontiers_label_dict_one = random.choice(frontiers_label_dict_list)
                    nav_point = frontiers_label_dict_one["centroid"]
                else:
                    nav_point = [0, 0, 0]
                # --------------------------------
