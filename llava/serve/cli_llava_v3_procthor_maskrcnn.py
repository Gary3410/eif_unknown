...
def main(args):
    ...
    # 初始化保存路径
    # base_save_path = "./log_file/llava_s1_s2_vln_parsed_response_procthor_detic_v13_easy_large_no_attention_0803"
    base_save_path = args.base_save_path
    if not os.path.exists(base_save_path):
        os.makedirs(base_save_path)

    # -------------------main loop--------------------------
    for val_dict_id, val_dict_one in enumerate(tqdm(instruction_dict_list[:20])):
        # if val_dict_id <= 1:
        #     continue
