...
def main(args):
    ...
    # 初始化保存路径
    base_save_path = "./log_file/llava_s1_s2_vln_parsed_response_v8_val_result_random_choice"
    if not os.path.exists(base_save_path):
        os.makedirs(base_save_path)

    # -------------------main loop--------------------------
    for val_dict_id, val_dict_one in enumerate(tqdm(instruction_dict_list[168:])):
    ...
    # 保存最终结果
    with open("llava_s1_s2_vln_parsed_response_v8_val_result_random_choice.pkl", 'wb') as f:
